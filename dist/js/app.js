    ...
    (() => {
        ...
        class Pizza {
            constructor(id) {
                ...
                this.sliceCount = 6;
                this.sliceSize = 75;
                this.width = this.height = this.canvas.height = this.canvas.width = 2 * this.sliceSize + 50;
            ...
            update() {
                ...
                if (--this.cooldown < 0) this.progress += .01 * this.sliceRadians + .07 * this.progress;
                ctx.save();
                ...
                for (let i = this.sliceCount - 1; i > 0; i--) {
                    ...
                    ctx.lineWidth = .3;
                    ctx.stroke();
                    let x = .65 * this.sliceSize * Math.cos(rad + this.sliceRadians / 2);
                    let y = .65 * this.sliceSize * Math.sin(rad + this.sliceRadians / 2);
                    ctx.beginPath();
        ...
        const pizzaObj = [ {
            id: "margo",
            name: "Маргарита",
            url: [ "img/generate/pizza/margo-1.png", "img/generate/pizza/margo-2.png", "img/generate/pizza/margo-3.png", "img/generate/pizza/margo-4.png", "img/generate/pizza/margo-5.png" ],
            link: "https://pizzato.rest/catalog/30"
        }, {
            id: "pepperoni",
            name: "Пепперони",
            url: [ "img/generate/pizza/pepper-1.png", "img/generate/pizza/pepper-2.png", "img/generate/pizza/pepper-3.png", "img/generate/pizza/pepper-4.png", "img/generate/pizza/pepper-5.png" ],
            link: "https://pizzato.rest/catalog/33"
        }, {
            id: "chicken",
            name: "С курицей и грибами",
            url: [ "img/generate/pizza/chicken-1.png", "img/generate/pizza/chicken-2.png", "img/generate/pizza/chicken-3.png", "img/generate/pizza/chicken-4.png", "img/generate/pizza/chicken-5.png", "img/generate/pizza/chicken-6.png" ],
            link: "https://pizzato.rest/catalog/35"
        }, {
            id: "bologna",
            name: "Болонья",
            url: [ "img/generate/pizza/bologna-1.png", "img/generate/pizza/bologna-2.png", "img/generate/pizza/bologna-3.png", "img/generate/pizza/bologna-4.png", "img/generate/pizza/bologna-5.png" ],
            link: "https://pizzato.rest/neapolitanskaya/pizza-bolonya"
        }, {
            id: "meat",
            name: "Мясная",
            url: [ "img/generate/pizza/meat-1.png", "img/generate/pizza/meat-2.png", "img/generate/pizza/meat-3.png", "img/generate/pizza/meat-4.png", "img/generate/pizza/meat-5.png" ],
        ...
        const utmChecker = () => {
            ...
            const utmEl = utms.find((utm => findedUtm?.toLowerCase().includes(findCompaign(utm.mark).toLowerCase())));
...
*/
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            const generatePizza = () => {
                ...
                setTimeout(countdown(actualRndmNum), actualRndmNum + 2e3);
                setTimeout((() => {
                    overlay.style.display = "none";
                    wrapperBlur.classList.toggle("wrapper-overlay");
                    if (document.querySelector(".generate__promo").innerHTML.length > 0) generatePromoBlock.style.display = "block"; else generatePromoBlock.style.display = "none";
                    pizzaLoadBlock.style.display = "none";
                    generateBlock.classList.add("generate__block-show");
                    gsapWithCSS.to(generateBlock, {
                        ease: "sine.inOut",
                        rotation: 5,
                        duration: 8,
                        yoyoEase: true,
